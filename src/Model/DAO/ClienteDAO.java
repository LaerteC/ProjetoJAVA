...
public class ClienteDAO {
    ...
    public void insert(Cliente cliente) throws SQLException {
        ...
        try{
            ...
            sql = "insert into cliente (cpf, nome, sobrenome, rg, endereco, salario) values (?,?,?,?,?,?)";
    ...
    public void delete(Cliente cliente) throws SQLException {
        ...
        try {
            ...
            sql = "delete from conta where idcliente  = ?";
            stmt = con.prepareStatement(sql);
    ...
    public List<Cliente> lista(String filtro, int ordenarPor) throws SQLException {
        ...
        try {
            ...
            con = Conexao.getConnection();
            sql = "select * from cliente where nome like ? or sobrenome like ? or rg = ? or cpf = ?";
    ...
    public void update(Cliente cliente) throws SQLException {
        ...
        try{
            con = Conexao.getConnection();
            sql = "update cliente set nome = ?, sobrenome = ?, rg = ?, cpf = ?, Endereco = ?, Salario = ? where idcliente = ?";
            stmt = con.prepareStatement(sql);
    ...
    public Cliente clienteNomeSobrenome(String nome, String sobrenome) throws SQLException{
        ...
        PreparedStatement stmt = null;
            try {
                ...
                String query = "select * from cliente where nome = ? and sobrenome = ?";
